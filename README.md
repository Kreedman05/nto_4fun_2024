...
- Оптимизирован запрос на регистрацию нового юзера в функции register, auth_api.py 109 str
- Добавить защиту от брутфорса в виде ограничение на количество попыток ввода пароля на определённом периоде времени auth_api.py 39 str
- Добавить более полную обработку исключений в работе с запросами auth_api.py str 232 str 269
- Добавить параметризированные запросы auth_api.py str 232 str 269 register updateUser
